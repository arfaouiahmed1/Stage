...
class Category3QuizScreen extends StatefulWidget {
  ...
  const Category3QuizScreen({Key? key, required this.island}) : super(key: key);
...
class _Category3QuizScreenState extends State<Category3QuizScreen>
  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'correct': 1,
      'explanation': 'The Apollo 11 mission successfully landed on the moon in July 1969.',
    },
    {
    ...
    {
      'question': 'The Great Wall was built primarily for what purpose?',
      'options': ['Transportation', 'Defense', 'Trade', 'Communication'],
      'correct': 1,
      'explanation': 'The Great Wall was built as a defensive fortification to protect against invasions.',
    },
    {
      'question': 'Which empire was known for building roads and aqueducts?',
      'options': ['Greek', 'Persian', 'Roman', 'Egyptian'],
      'correct': 2,
      'explanation': 'The Roman Empire was famous for its engineering, especially roads and aqueducts.',
    },
    {
      'question': 'What year marked the end of World War II?',
      'options': ['1944', '1945', '1946', '1947'],
      'correct': 1,
      'explanation': 'World War II officially ended in 1945 after the surrender of Japan.',
    },
    {
    ...
    },
    {
      ...
      'correct': 2,
      'explanation': 'The Renaissance began in Italy during the 14th century and spread throughout Europe.',
    },
  ];
  ...
  String _getResultMessage(double percentage) {
    if (percentage >= 90) return 'Outstanding! You have great knowledge! 🌟';
    if (percentage >= 80) return 'Wonderful! You did really well! 🏆';
    if (percentage >= 60) return 'Nice work! Keep learning! 👍';
    return 'Don\'t worry! Keep exploring! 💪';
  }
