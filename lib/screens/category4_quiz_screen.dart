...
class Category4QuizScreen extends StatefulWidget {
  ...
  const Category4QuizScreen({Key? key, required this.island}) : super(key: key);
...
class _Category4QuizScreenState extends State<Category4QuizScreen>
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question': 'Which genre focuses on imaginary future worlds?',
      'options': ['Romance', 'Mystery', 'Fantasy', 'Biography'],
      'correct': 2,
      'explanation': 'Fantasy literature often features imaginary worlds, magic, and supernatural elements.',
    },
    {
      'question': 'What is a collection of poems called?',
      'options': ['Anthology', 'Novel', 'Drama', 'Essay'],
      'correct': 0,
      'explanation': 'An anthology is a collection of literary works, especially poems.',
    },
    {
    ...
    },
    {
      ...
      'options': ['Antagonist', 'Narrator', 'Protagonist', 'Supporting character'],
      'correct': 2,
      'explanation': 'The protagonist is the main character around whom the story revolves.',
    },
    {
      'question': 'Which form of writing tells a story in verse?',
      'options': ['Epic poem', 'Short story', 'Play', 'Essay'],
      'correct': 0,
      'explanation': 'Epic poems are long narrative poems that tell stories, often about heroic deeds.',
    },
    {
      'question': 'What do we call the lesson or message in a story?',
    ...
    {
      'question': 'Which type of writing aims to persuade the reader?',
      'options': ['Narrative', 'Descriptive', 'Expository', 'Argumentative'],
      'correct': 3,
      'explanation': 'Argumentative writing aims to convince readers to accept a particular viewpoint.',
    },
  ];
  ...
  String _getResultMessage(double percentage) {
    if (percentage >= 90) return 'Brilliant! You\'re a true wordsmith! 🌟';
    if (percentage >= 80) return 'Excellent! Your knowledge is impressive! 🏆';
    if (percentage >= 60) return 'Well done! Keep reading and learning! 👍';
